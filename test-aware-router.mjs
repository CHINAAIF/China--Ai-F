import { getRoutingChain } from './lib/sovereign-router.mjs';
import { writeMemory, generateMemoryToken } from './lib/blackboard.js';

console.log("--- Starting Cognitive Aware Router Test ---");

async function runTest() {
  const token = generateMemoryToken('provider_watchdog');
  
  console.log("1. Injecting Fake Health Data (Groq is dead)...");
  const fakeLedger = {
