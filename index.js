...
const app = express();
const PORT = parseInt(process.env.RAILWAY_PORT || process.env.PORT || 5000, 10);
let pool = null;
let ready = false;
...
app.listen(PORT, '0.0.0.0', () => {
  console.log('TRUNKIA listening on ' + PORT + ' | env PORT=' + process.env.PORT + ' | RAILWAY_PORT=' + (process.env.RAILWAY_PORT || 'not set'));
  ready = true;
  (async () => {
    try {
