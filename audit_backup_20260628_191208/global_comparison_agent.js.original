/**
 * global_comparison_agent | layer: intelligence
...
class GlobalComparisonAgent {
  constructor() {
    this.name = 'global_comparison_agent';
  ...
  async run(input = {}) {
    const prompt = `Compare Chinese AI ecosystem vs US, EU, and other global AI ecosystems across metrics.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"comparison":{"china":{"score":0,"strengths":[],"weaknesses":[]},"us":{"score":0,"strengths":[],"weaknesses":[]}},"gap":"...","confidence":85}`;
...
export const globalComparisonAgent = new GlobalComparisonAgent();
export default globalComparisonAgent;
