/**
 * translation_ru_agent | layer: content
...
class TranslationRuAgent {
  ...
  async run(input = {}) {
    const prompt = `Translate Chinese AI intelligence content to Russian.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"translated":"...","source":"en","target":"ru","terms_glossary":{},"confidence":85}`;
...
export const translationRuAgent = new TranslationRuAgent();
