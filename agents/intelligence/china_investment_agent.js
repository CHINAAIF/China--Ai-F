 ...
 * Agent: china_investment_agent | Layer: intelligence
 */
...
if (process.argv[1] && process.argv[1].endsWith('china_investment_agent.js')) {
    const instance = new ChinaInvestmentAgent();
