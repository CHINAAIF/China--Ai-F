...
class ChinaPolicyAgent {
  ...
  async run(input = {}) {
    const prompt = `Analyze Chinese government AI policies, regulations, five-year plans, and strategic directives.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"policies":[{"name":"...","impact":"high|medium|low","sector":"...","effective_date":"..."}],"overall_direction":"...","confidence":85}`;
...
export const chinaPolicyAgent = new ChinaPolicyAgent();
