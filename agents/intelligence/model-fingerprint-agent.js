import dotenv from 'dotenv'; import pg from 'pg'; import crypto from 'crypto'; const pool = new pg.Pool({connectionString:process.env.DATABASE_URL_INTELLIGENCE,ssl: true});
const QUESTIONS=[
