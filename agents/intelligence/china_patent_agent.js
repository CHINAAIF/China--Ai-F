/**
 * china_patent_agent | layer: intelligence
...
class ChinaPatentAgent {
  constructor() {
    this.name = 'china_patent_agent';
...
export const chinaPatentAgent = new ChinaPatentAgent();
export default chinaPatentAgent;
