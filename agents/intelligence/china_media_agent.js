/**
 * china_media_agent | layer: intelligence
...
class ChinaMediaAgent {
  constructor() {
    this.name = 'china_media_agent';
  ...
  async run(input = {}) {
    const prompt = `Monitor Chinese AI media coverage: key narratives, propaganda signals, international perception.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"narratives":[{"theme":"...","sentiment":"positive|negative|neutral","reach":"high|medium|low"}],"confidence":85}`;
...
export const chinaMediaAgent = new ChinaMediaAgent();
export default chinaMediaAgent;
