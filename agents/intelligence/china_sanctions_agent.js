 ...
 * Agent: china_sanctions_agent | Layer: intelligence
 */
...
if (process.argv[1] && process.argv[1].endsWith('china_sanctions_agent.js')) {
    const instance = new ChinaSanctionsAgent();
