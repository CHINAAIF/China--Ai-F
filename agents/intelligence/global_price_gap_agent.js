/**
 * global_price_gap_agent | layer: intelligence
...
class GlobalPriceGapAgent {
  ...
  async run(input = {}) {
    const prompt = `Analyze price gaps between Chinese AI APIs and global competitors. Identify arbitrage opportunities.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"gaps":[{"model_chinese":"...","model_global":"...","chinese_price":"...","global_price":"...","gap_pct":0}],"biggest_gap":"...","confidence":85}`;
...
export const globalPriceGapAgent = new GlobalPriceGapAgent();
