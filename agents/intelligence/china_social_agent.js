 ...
 * Agent: china_social_agent | Layer: intelligence
 */
import dotenv from 'dotenv';
dotenv.config();

class ChinaSocialAgent {
    constructor() {
...
if (process.argv[1] && process.argv[1].endsWith('china_social_agent.js')) {
    const instance = new ChinaSocialAgent();
