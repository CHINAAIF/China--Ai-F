/**
 * china_research_agent | layer: intelligence
...
class ChinaResearchAgent {
  constructor() {
    this.name = 'china_research_agent';
  ...
  async run(input = {}) {
    const prompt = `Track Chinese AI research: papers, benchmarks, university output, research institutes.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"research":[{"title":"...","institution":"...","impact":"high|medium|low","area":"..."}],"output_trend":"up|down|stable","confidence":85}`;
...
export const chinaResearchAgent = new ChinaResearchAgent();
export default chinaResearchAgent;
