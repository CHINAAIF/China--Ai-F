 ...
 * Agent: performance_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('performance_agent.js')) {
    const instance = new PerformanceAgent();
