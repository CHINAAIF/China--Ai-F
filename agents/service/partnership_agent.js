 ...
 * Agent: partnership_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('partnership_agent.js')) {
    const instance = new PartnershipAgent();
