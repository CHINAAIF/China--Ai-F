 ...
 * Agent: price_alert_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('price_alert_agent.js')) {
    const instance = new PriceAlertAgent();
