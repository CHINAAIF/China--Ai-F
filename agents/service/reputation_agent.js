 ...
 * Agent: reputation_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('reputation_agent.js')) {
    const instance = new ReputationAgent();
