 ...
 * Agent: notification_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('notification_agent.js')) {
    const instance = new NotificationAgent();
