 ...
 * Agent: recommendation_agent | Layer: service
 */
...
class RecommendationAgent {
    constructor() {
        this.name = 'recommendation_agent';
        this.layer = 'service';
        this.status = 'active';
    }
...
if (process.argv[1] && process.argv[1].endsWith('recommendation_agent.js')) {
    const instance = new RecommendationAgent();
