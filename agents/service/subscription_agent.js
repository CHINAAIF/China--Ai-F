 ...
 * Agent: subscription_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('subscription_agent.js')) {
    const instance = new SubscriptionAgent();
