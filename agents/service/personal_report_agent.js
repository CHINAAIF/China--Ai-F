 ...
 * Agent: personal_report_agent | Layer: service
 */
...
class PersonalReportAgent {
    constructor() {
        this.name = 'personal_report_agent';
        this.layer = 'service';
        this.status = 'active';
    }
...
if (process.argv[1] && process.argv[1].endsWith('personal_report_agent.js')) {
    const instance = new PersonalReportAgent();
...
export default PersonalReportAgent;
