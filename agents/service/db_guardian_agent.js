 ...
 * Agent: db_guardian_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('db_guardian_agent.js')) {
    const instance = new DbGuardianAgent();
...
export default DbGuardianAgent;
