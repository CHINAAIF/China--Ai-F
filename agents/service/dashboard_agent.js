 ...
 * Agent: dashboard_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('dashboard_agent.js')) {
    const instance = new DashboardAgent();
