 ...
 * Agent: log_analyzer_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('log_analyzer_agent.js')) {
    const instance = new LogAnalyzerAgent();
...
export default LogAnalyzerAgent;
