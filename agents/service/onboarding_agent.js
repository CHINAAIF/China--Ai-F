 ...
 * Agent: onboarding_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('onboarding_agent.js')) {
    const instance = new OnboardingAgent();
