 ...
 * Agent: error_recovery_agent | Layer: service
 */
...
class ErrorRecoveryAgent {
    constructor() {
        this.name = 'error_recovery_agent';
        this.layer = 'service';
        this.status = 'active';
    }
...
if (process.argv[1] && process.argv[1].endsWith('error_recovery_agent.js')) {
    const instance = new ErrorRecoveryAgent();
