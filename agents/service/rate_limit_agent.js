 ...
 * Agent: rate_limit_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('rate_limit_agent.js')) {
    const instance = new RateLimitAgent();
