 ...
 * Agent: ab_testing_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('ab_testing_agent.js')) {
    const instance = new AbTestingAgent();
