 ...
 * Agent: api_monitor_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('api_monitor_agent.js')) {
    const instance = new ApiMonitorAgent();
...
export default ApiMonitorAgent;
