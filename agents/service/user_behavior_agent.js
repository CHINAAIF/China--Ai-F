 ...
 * Agent: user_behavior_agent | Layer: service
 */
...
if (process.argv[1] && process.argv[1].endsWith('user_behavior_agent.js')) {
    const instance = new UserBehaviorAgent();
