 ...
 * Agent: task_distributor | Layer: governance
 */
...
if (process.argv[1] && process.argv[1].endsWith('task_distributor.js')) {
    const instance = new TaskDistributor();
