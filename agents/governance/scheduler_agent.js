 ...
 * Agent: scheduler_agent | Layer: governance
 */
...
if (process.argv[1] && process.argv[1].endsWith('scheduler_agent.js')) {
    const instance = new SchedulerAgent();
