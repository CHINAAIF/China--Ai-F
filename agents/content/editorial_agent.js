...
class EditorialAgent {
  ...
  async run(input = {}) {
    const prompt = `Apply editorial standards to AI intelligence content: accuracy, tone, structure.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"approved":true,"edits":[],"editorial_score":0,"confidence":85}`;
