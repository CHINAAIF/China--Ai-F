...
class AdsenseAgent {
  ...
  async run(input = {}) {
    const prompt = `Optimize AI intelligence content for ad revenue and engagement metrics.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"recommendations":[],"estimated_rpm":0,"best_placements":[],"confidence":85}`;
...
export const adsenseAgent = new AdsenseAgent();
