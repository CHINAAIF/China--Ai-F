...
class ImageAgent {
  ...
  async run(input = {}) {
    const prompt = `Generate image prompts and alt text for AI intelligence visual content.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"image_prompt":"...","alt_text":"...","style":"...","confidence":85}`;
