/**
 * translation_zh_agent | layer: content
...
class TranslationZhAgent {
  constructor() {
    this.name = 'translation_zh_agent';
    this.layer = 'content';
    this.status = 'active';
  }
  ...
  async run(input = {}) {
    const prompt = `Translate AI intelligence content to Chinese (Simplified). Preserve technical terms.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"translated":"...","source":"en","target":"zh","terms_glossary":{},"confidence":85}`;
...
export const translationZhAgent = new TranslationZhAgent();
export default translationZhAgent;
