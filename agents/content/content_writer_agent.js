...
const pool = getPool('main', generateDbToken('agents/content/content_writer_agent.js'));;
...
class ContentWriterAgent {
  constructor() {
    this.name = 'content_writer_agent';
    this.layer = 'content';
    this.status = 'active';
  }
  ...
  async run(input = {}) {
    const prompt = `Write structured AI intelligence articles and reports about Chinese AI.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"article":{"title":"...","body":"...","word_count":0},"confidence":85}`;
