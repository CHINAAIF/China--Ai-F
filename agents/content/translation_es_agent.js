...
class TranslationEsAgent {
  constructor() {
    this.name = 'translation_es_agent';
    this.layer = 'content';
    this.status = 'active';
  }
  ...
  async run(input = {}) {
    const prompt = `Translate Chinese AI intelligence content to Spanish.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"translated":"...","source":"en","target":"es","terms_glossary":{},"confidence":85}`;
...
export const translationEsAgent = new TranslationEsAgent();
export default translationEsAgent;
