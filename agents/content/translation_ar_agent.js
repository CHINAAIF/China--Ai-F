/**
 * translation_ar_agent | layer: content
...
class TranslationArAgent {
  constructor() {
    this.name = 'translation_ar_agent';
    this.layer = 'content';
    this.status = 'active';
  }
  ...
  async run(input = {}) {
    const prompt = `Translate Chinese AI intelligence content to Arabic with technical accuracy.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"translated":"...","source":"en","target":"ar","terms_glossary":{},"confidence":85}`;
...
export const translationArAgent = new TranslationArAgent();
export default translationArAgent;
