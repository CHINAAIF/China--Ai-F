...
class SummaryAgent {
  ...
  async run(input = {}) {
    const prompt = `Generate concise summaries of Chinese AI intelligence for different audiences.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"executive_summary":"...","technical_summary":"...","key_takeaways":[],"confidence":85}`;
