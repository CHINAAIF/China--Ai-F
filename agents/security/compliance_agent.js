/**
 * compliance_agent | layer: security
...
class ComplianceAgent {
  ...
  async run(input = {}) {
    const prompt = `Check compliance with Chinese AI regulations, data laws, and platform policies.\n\nInput: ${JSON.stringify(input)}\n\nRespond ONLY with JSON: {"compliant":true,"violations":[],"recommendations":[],"regulation":"...","confidence":85}`;
