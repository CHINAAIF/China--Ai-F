 ...
 * Agent: release_prediction_agent | Layer: analysis
 */
...
if (process.argv[1] && process.argv[1].endsWith('release_prediction_agent.js')) {
    const instance = new ReleasePredictionAgent();
