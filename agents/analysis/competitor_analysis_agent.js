 ...
 * Agent: competitor_analysis_agent | Layer: analysis
 */
...
if (process.argv[1] && process.argv[1].endsWith('competitor_analysis_agent.js')) {
    const instance = new CompetitorAnalysisAgent();
