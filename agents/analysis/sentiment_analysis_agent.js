 ...
 * Agent: sentiment_analysis_agent | Layer: analysis
 */
...
if (process.argv[1] && process.argv[1].endsWith('sentiment_analysis_agent.js')) {
    const instance = new SentimentAnalysisAgent();
